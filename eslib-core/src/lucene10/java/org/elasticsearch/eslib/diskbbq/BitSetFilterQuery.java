...
/**
 * A simple filter query backed by a FixedBitSet of allowed doc IDs.
 */
public class BitSetFilterQuery extends Query {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof BitSetFilterQuery that)) return false;
    ...
    /**
     * Simple DocIdSetIterator over a FixedBitSet.
     */
