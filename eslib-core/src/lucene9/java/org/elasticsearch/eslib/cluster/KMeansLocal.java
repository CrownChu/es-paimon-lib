...
abstract class KMeansLocal {
    ...
    protected abstract boolean stepLloyd(
        IndexedFloatVectorValues vectors,
     ...
     */
    static float[][] pickInitialCentroids(IndexedFloatVectorValues vectors, int centroidCount) throws IOException {
     ...
     * @throws IOException is thrown if vectors is inaccessible
     */
    final void cluster(IndexedFloatVectorValues vectors, KMeansIntermediate kMeansIntermediate) throws IOException {
     ...
     */
    final void cluster(IndexedFloatVectorValues vectors, KMeansIntermediate kMeansIntermediate, int clustersPerNeighborhood, float soarLambda)
        throws IOException {
    ...
    private void doCluster(IndexedFloatVectorValues vectors, KMeansIntermediate kMeansIntermediate, int clustersPerNeighborhood, float soarLambda)
        throws IOException {
        float[][] centroids = kMeansIntermediate.centroids();
    ...
    private void cluster(IndexedFloatVectorValues vectors, KMeansIntermediate kMeansIntermediate, NeighborHood[] neighborhoods)
        throws IOException {
        float[][] centroids = kMeansIntermediate.centroids();
        ...
        IndexedFloatVectorValues sampledVectors = vectors;
        if (sampleSize < n) {
    ...
    /**
     * helper that calls {@link KMeansLocal#cluster(IndexedFloatVectorValues, KMeansIntermediate)} given a set of initialized centroids,
     ...
     */
    public static void cluster(IndexedFloatVectorValues vectors, float[][] centroids, int sampleSize, int maxIterations) throws IOException {
