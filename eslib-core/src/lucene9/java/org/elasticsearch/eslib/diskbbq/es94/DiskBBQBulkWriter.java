...
public abstract class DiskBBQBulkWriter {
    ...
    public static DiskBBQBulkWriter fromBitSize(
        ...
        // JDK 11 port: switch expression -> traditional switch (no byte-layout impact).
        switch (bitSize) {
            case 1:
            case 2:
            case 4:
                return blockEncodeTailVectors
    ...
    private static class SmallBitDiskBBQBulkWriter extends DiskBBQBulkWriter {
    ...
    private static class LargeBitDiskBBQBulkWriter extends DiskBBQBulkWriter {
        protected final OptimizedScalarQuantizer.QuantizationResult[] corrections;
