...
public class PaimonDiskBBQVectorsFormat extends KnnVectorsFormat {
    ...
    public PaimonDiskBBQVectorsFormat(int vectorPerCluster, int centroidsPerParentCluster) {
        this(vectorPerCluster, centroidsPerParentCluster, DEFAULT_PARALLEL_THRESHOLD, null);
    }
    ...
    public KnnVectorsReader fieldsReader(SegmentReadState state) throws IOException {
        return new DiskBBQVectorsReader(state, vectorPerCluster, centroidsPerParentCluster,
                parallelThreshold, executor);
    }
