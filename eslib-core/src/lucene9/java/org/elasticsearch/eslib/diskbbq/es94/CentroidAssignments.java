...
// JDK 11 port: was `public record CentroidAssignments(int numCentroids, float[][] centroids,
// int[] assignments, int[] overspillAssignments, float[] globalCentroid)`. Hand-expanded to a final
// class with the same component accessors; no behavior/byte change.
