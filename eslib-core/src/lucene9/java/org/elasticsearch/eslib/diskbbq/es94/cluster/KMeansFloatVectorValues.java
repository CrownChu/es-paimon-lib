...
public final class KMeansFloatVectorValues extends ClusteringFloatVectorValues {
    ...
    // JDK 11 port: was a `sealed interface` permitting the two suppliers; plain interface here.
    ...
    // JDK 11 port: was `private record OnHeapVectorSupplier(List<float[]> vectors, int dims)`.
    ...
    // JDK 11 port: was `private record OffHeapVectorSupplier(IndexInput vectors, float[] vector, long vectorLength)`.
    ...
    // JDK 11 port: was a `sealed interface` permitting the two doc suppliers; plain interface here.
    ...
    // JDK 11 port: was `private record OnHeapDocSupplier(int[] docs)`.
    ...
    // JDK 11 port: was `private record OffHeapDocSupplier(IndexInput docs, RandomAccessInput randomDocs)`.
